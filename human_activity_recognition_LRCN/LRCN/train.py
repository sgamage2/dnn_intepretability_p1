...
parser.add_argument('--sampled_data_dir',
                    default=r'../Datasets/UCF101_sampled_data_video_sampling_rate_10_num_frames_extracted_5/',
                    type=str, help='The dir for the sampled row data')
parser.add_argument('--ucf_list_dir', default=r'../Datasets/ucfTrainTestlist/',
