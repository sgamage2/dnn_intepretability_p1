...
from model import MNIST_NN, MNIST_DNN, LRP, InceptionV3_Network
...
conv_ksize = [1, 3, 3, 1] #([batch, height, width, channels])
pool_ksize = [1, 2, 2, 1]
